...
pygame.init()
floor_x = bird_moment = score = hight_score = bird_index = 0
pipe_height = [0,20,-20,40,-40,60,-60,80,-80,100,-100,120,-120,140,-140,160,-160]
pipe_y = random.choice(pipe_height)
speed = 4
game_play = True
game_active = True
...
pipe = draw("Program/pipe.png")
pipe2 = draw("Program/pipe2.png")
pipe_rect = pipe.get_rect(midtop = (500,450-pipe_y))
pipe2_rect = pipe.get_rect(midtop = (500,450-750-pipe_y))
game_over = draw_alpha("Program/message.png")
game_over_rect = game_over.get_rect(center = (216,384))
bird_mid = draw_alpha("Program/bird.png")
bird_up = draw_alpha("Program/bird_up.png")
...
while game_play:
	...
	if floor_x <= -432:
		floor_x = 0
	pygame.display.update()
>>>>>>> eaae5db61686c255c2d9d544966aa9da8f9927cf:Flappy Bird/Update_1.py
pygame.quit()